...
#include<array>
    ...
    {
		friend class AdvancedIntersectionTest;
		friend class AdvancedCollisionDetection;
    public:
		CollisionPrimitive(std::string s)
		{
			body = new RigidBody(s);
		}
		~CollisionPrimitive()
		{
			delete body;
	...
	public:
		...
		/*funzione che ritorna il vettore prevPosition, e che se non inizializzato, lo inizializza alla posizione attuale*/
    ...
    {
    public:
		CollisionSphere(std::string s) :CollisionPrimitive(s){}
        /**
    ...
    {
    public:
		CollisionBox(const std::string& s,const float& L1, const float& L2, const float& L3 ) :CollisionPrimitive(s)
		{
			halfSize[0] = L1;
			halfSize[1] = L2;
			halfSize[2] = L3;
    ...
    struct CollisionData
    {
        ...
        CollisionData(){
   //         contactArray = new Contact[256];/* [256]; */
    ...
    {
	public:
		static rtcdNS::AdvancedCollisionDetector ACD;
