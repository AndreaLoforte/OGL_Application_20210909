...
namespace myobjectNS {
    ...
    // ctor
    ///////////////////////////////////////////////////////////////////////////////
    Sphere2::Sphere2(std::string sh_prog_name, float radius, int sectors, int stacks, bool smooth) :
        interleavedStride(32),
        ObjectSphere(sh_prog_name),
        ShaderObject(sh_prog_name, "sphere/sphere_external/")
    {
    ...
    // setters
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::set(float radius, int sectors, int stacks, bool smooth)
    {
        this->radius = radius;
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::render(const fpcameraNS::Transformation& cam)
    {
        // interleaved array
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::drawLines(const float lineColor[4]) const
    {
        // set line colour
    ...
    // the caller must set the line width before call this
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::drawWithLines(const float lineColor[4]) const
    {
    ...
    */
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::buildVerticesSmooth()
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::buildVerticesFlat()
    {
        const float PI = acos(-1);
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::buildInterleavedVertices()
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::addVertex(float x, float y, float z)
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::addNormal(float nx, float ny, float nz)
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::addTexCoord(float s, float t)
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    void Sphere2::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    std::vector<float> Sphere2::computeFaceNormal(float x1, float y1, float z1,  // v1
