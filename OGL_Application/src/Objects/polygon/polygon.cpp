...
namespace myobjectNS {
	...
	void Polygon::render(const fpcameraNS::Transformation& cam)
	{
	...
	void Polygon::renderCollisionPrimitive()
	{
		glUseProgram(shader_prog);
		glBindVertexArray(VAO);
		static GLuint modelviewMAttribLocation = glGetUniformLocation(shader_prog, "modelviewM");
	...
	void Polygon::update(const float& duration) {
	...
	void Polygon::setRigidBodyParameters() {
