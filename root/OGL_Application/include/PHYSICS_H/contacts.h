...
#include<body.h>
    ...
    protected:
		...
		/*funzione chiamata da soundMap
		per stabilire se la velocità di impatto tra
		i corpi è tale da dover produrre un suono*/
		float getDeltaVelocity()
		{	
    ...
    public:
         ...
         */
        ContactResolver(unsigned iterations = 10,
