...
{
	static LONGLONG lpFrequency;
	if (!QueryPerformanceFrequency((LARGE_INTEGER*)&lpFrequency))
		logNS::Logger::writeLog("timing.cpp : the system does not support high resolution performance counter");
	return (unsigned)(lpFrequency);
