...
namespace myobjectNS {
	...
	void BoxAABB::render(const fpcameraNS::Transformation& cam)
	{
	...
	void BoxAABB::update(const float& duration){
	...
	void BoxAABB::setRigidBodyParameters() {
	...
	void BoxAABB::setPosition(const std::array<float, 3>& pos) {
