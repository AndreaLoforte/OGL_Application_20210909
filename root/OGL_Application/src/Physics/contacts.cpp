...
void Contact::calculateDesiredDeltaVelocity(real duration)
{
    ...
    // acceleration velocity.
		...
		//delta = vel_finale - vel_iniziale =
		//vel_f = - restitution*vel_impatto
                                       ...
                                       real duration)
{
    ...
    while (velocityIterationsUsed < velocityIterations)
    {
        ...
        /*andiamo a trovare il contatto a cui bisogna applicare il delta desiderato :
		scorriamo tutti i contatti*/
            for (unsigned i = 0; i < numContacts; i++)
        {
            ...
            for (unsigned b = 0; b < 2; b++) if (c[i].body[b])
            {
                ...
                {
					/*entro solo quando (i,b) == (index,0) o (i,b) == (index,1)
					dove index è l'indice del contatto con desiredDeltaVeocity maggiore.
					Una volta entrato applico la variazione di velocità al corpo b*/
					/*che cosa gli serve iterare su i se già sappiamo che 
					dobbiamo entrare con i = index ? 
					Perchè non è vero che entriamo solo con i = index .
					Più contatti possono avere lo stesso body...
					la cosa importante è applicare il delta di velocità a
					tutti i contatti che hanno il corpo individuato nel contatto
					di indice index*/
