 ...
 */
/* static inline  */void RigidBody::_calculateTransformMatrix(Matrix4 &transformMatrix,
...
void RigidBody::setPrevPosition(const real x, const real y, const real z)
{
	prevPosition.x = x;
	prevPosition.y = y;
	prevPosition.z = z;
...
void RigidBody::setAwake(const bool awake)
{
    if (awake) {
        ...
        motion = sleepEpsilon*2.0f/globalNS::WORLDSCALINGFACTOR;
    } else {
        isAwake = false;
        velocity.clear();
        rotation.clear();
